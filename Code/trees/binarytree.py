...
class BinaryTreeNode(object):
    ...
    def height(self):
        ...
        Best Case: O(1) if item is located in root node
        Worst Case: O(n) if item is not located in root"""
...
class BinarySearchTree(object):
    ...
    def search(self, item):
        ...
        TODO: Best case running time: ??? under what conditions?
        TODO: Worst case running time: ??? under what conditions?
        Best Case: O(1) if item is root
        Worst Case: O(Log n) otherwise"""
        # Find a node with the given item, if any
        node = self._find_node_recursive(item, self.root)
    ...
    def insert(self, item):
        ...
        TODO: Worst case running time: ??? under what conditions?
        Best Case: O(Log n)
        Best Case: O(1) is root
        Worst Case: O(log n) is not root"""
    ...
    def _find_node_iterative(self, item):
        ...
        TODO: Worst case running time: ??? under what conditions?
        Best Case: O(1) if item is root
        Worst Case: O(log n) if not root"""
    ...
    def _find_parent_node_recursive(self, item, node, parent=None):
        ...
        # TODO: Check if the given item is less than the node's data
            ...
            return self._find_parent_node_recursive(item, node.left, parent=node)  # Hint: Remember to update the parent parameter
        # TODO: Check if the given item is greater than the node's data
        elif node.data < item:
            print(f'node.data: {node.data}, item: {item}')
            # TODO: Recursively descend to the node's right child, if it exists
            return self._find_parent_node_recursive(item, node.right, parent=node)  # Hint: Remember to update the parent parameter
